...
ActiveRecord::Schema[8.0].define(version: 20_251_202_054_116) do # rubocop:disable Metrics/BlockLength
  create_schema 'auth'
  ...
  create_table 'org_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[org_id user_id], name: 'index_org_roles_on_org_id_and_user_id', unique: true
  end
